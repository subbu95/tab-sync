...
import * as mrgConfig from './product-mapped-char-rule-generation.config'
...
@Component({
  selector: 'eclipse-product-mapped-char-rule-generation',
  standalone: true,
  ...
  templateUrl: './product-mapped-char-rule-generation.component.html',
  styleUrl: './product-mapped-char-rule-generation.component.scss',
})
export class ProductMappedCharRuleGenerationComponent implements OnInit, OnDestroy, AfterViewInit {
  title = CONSTANTS.DETAILS_TITLE;
  monId!: number;
  detailsPath: string = CONSTANTS.FUP.MRG.STEP_DETAILS_API_PATH;
  ...
  public columns = mrgConfig.columns; // Get the grid column names from component config
  public filterFieldDetails!: filterFieldDetailsObject; // Get the filter field details from component config
  public filterDetails = mrgConfig.filterDetails; // Get the filter details from component config
  public screenHeaderComponentDetails = mrgConfig.screenHeaderComponentDetails; // Get the header details from component config like title & action buttons
  public historyScreenDetails = mrgConfig.historyScreenDetails; // Get the history screen details from component config
  public excelExportApiPath = mrgConfig.excelExportApiPath;
  ...
  ngOnInit() {
    ...
    this.route.queryParams.subscribe((params) => {
      mrgConfig.filterFieldDetails.dropDown?.forEach(field => {
      ...
      this.filterFieldDetails = mrgConfig.filterFieldDetails;
