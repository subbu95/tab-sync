import { ProductMappedCharRuleGenerationComponent } from './product-mapped-char-rule-generation.component';
...
describe('ProductMappedCharRuleGenerationComponent', () => {
    let fixture: ComponentFixture<ProductMappedCharRuleGenerationComponent>;
    let component: ProductMappedCharRuleGenerationComponent;
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [ProductMappedCharRuleGenerationComponent, BrowserAnimationsModule],
            providers: [
                { provide: FilterapiService, useValue: filterapiServiceSpy }
            ],
        }).compileComponents();
        fixture = TestBed.createComponent(ProductMappedCharRuleGenerationComponent);
    ...
    it('should initialize dataArray correctly from filterService data', () => {
        ...
        component.ngOnInit();
        expect(component.dataArray).toEqual(mockData['fup/mrg/list'].body.content);
    });
