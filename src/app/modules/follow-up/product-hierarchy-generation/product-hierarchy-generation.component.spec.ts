import { ProductHierarchyGenerationComponent } from './product-hierarchy-generation.component';
...
describe('ProductHierarchyGenerationComponent', () => {
    let fixture: ComponentFixture<ProductHierarchyGenerationComponent>;
    let component: ProductHierarchyGenerationComponent;
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [ProductHierarchyGenerationComponent, BrowserAnimationsModule],
            providers: [
                { provide: FilterapiService, useValue: filterapiServiceSpy }
            ],
        }).compileComponents();
        fixture = TestBed.createComponent(ProductHierarchyGenerationComponent);
    ...
    it('should initialize dataArray correctly from filterService data', () => {
        ...
        component.ngOnInit();
        expect(component.dataArray).toEqual(mockData['fup/phg/list'].body.content);
    });
