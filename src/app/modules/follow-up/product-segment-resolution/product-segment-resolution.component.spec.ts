import { ProductSegmentResolutionComponent } from './product-segment-resolution.component';
...
describe('ProductSegmentResolutionComponent', () => {
    let fixture: ComponentFixture<ProductSegmentResolutionComponent>;
    let component: ProductSegmentResolutionComponent;
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [ProductSegmentResolutionComponent, BrowserAnimationsModule],
            providers: [
                { provide: FilterapiService, useValue: filterapiServiceSpy }
            ],
        }).compileComponents();
        fixture = TestBed.createComponent(ProductSegmentResolutionComponent);
    ...
    it('should initialize dataArray correctly from filterService data', () => {
        ...
        component.ngOnInit();
        expect(component.dataArray).toEqual(mockData['fup/psr/list'].body.content);
    });
