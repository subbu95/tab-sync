...
export const listApi = 'fup/psr/list';
export const excelExportApiPath = 'fup/psr/excelExport';
export const columns = ['Country', 'Week id', 'User', 'PRS id', 'PRS code', 'Version', 'Last step', 'Session', 'Status', 'Result', 'Unix', 'Job id', 'Date'];
...
export const historyScreenDetails: historyScreenDetailsObject = {
    'screenTitle': 'PSR3 - Product segment resolution',
    'screenComponentName': 'product-segment-resolution',
...
export const screenHeaderComponentDetails: screenHeaderComponentDetailsObject = {
    screenTitle: 'PSR1 - Product segment resolution- last steps',
    back: {
