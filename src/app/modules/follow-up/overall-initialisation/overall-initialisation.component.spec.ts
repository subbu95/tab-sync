...
import { OverallInitialisationComponent } from './overall-initialisation.component';
import { ApiResponse, FilterapiService } from '../../../services/filterapi.service';
import { BehaviorSubject, of, throwError } from 'rxjs';
describe('OverallInitialisationComponent', () => {
    let fixture: ComponentFixture<OverallInitialisationComponent>;
    let component: OverallInitialisationComponent;
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [OverallInitialisationComponent, BrowserAnimationsModule],
            providers: [
                { provide: FilterapiService, useValue: filterapiServiceSpy }
            ],
        }).compileComponents();
        fixture = TestBed.createComponent(OverallInitialisationComponent);
    ...
    it('should initialize dataArray correctly from filterService data', () => {
        ...
        component.ngOnInit();
        expect(component.dataArray).toEqual(mockData['fup/ini/list'].body.content);
    });
