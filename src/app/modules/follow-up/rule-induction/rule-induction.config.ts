...
export const listApi = 'fup/rin/list';
export const excelExportApiPath = 'fup/rin/excelExport';
...
export const historyScreenDetails: historyScreenDetailsObject = {
    'screenTitle': 'RIN3 - Rule induction',
    'screenComponentName': 'rule-induction',
...
export const screenHeaderComponentDetails: screenHeaderComponentDetailsObject = {
    screenTitle: 'RIN1 - Rule induction- last steps',
    back: {
