import { RuleInductionComponent } from './rule-induction.component';
...
describe('RuleInductionComponent', () => {
    let fixture: ComponentFixture<RuleInductionComponent>;
    let component: RuleInductionComponent;
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [RuleInductionComponent, BrowserAnimationsModule],
            providers: [
                { provide: FilterapiService, useValue: filterapiServiceSpy }
            ],
        }).compileComponents();
        fixture = TestBed.createComponent(RuleInductionComponent);
    ...
    it('should initialize dataArray correctly from filterService data', () => {
        ...
        component.ngOnInit();
        expect(component.dataArray).toEqual(mockData['fup/rin/list'].body.content);
    });
