...
import { ResolutionByUserComponent } from './resolution-by-user.component';
import { ApiResponse, FilterapiService } from '../../../services/filterapi.service';
import { BehaviorSubject, of, throwError } from 'rxjs';
describe('ResolutionByUserComponent', () => {
    let fixture: ComponentFixture<ResolutionByUserComponent>;
    let component: ResolutionByUserComponent;
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [ResolutionByUserComponent, BrowserAnimationsModule],
            providers: [
                { provide: FilterapiService, useValue: filterapiServiceSpy }
            ],
        }).compileComponents();
        fixture = TestBed.createComponent(ResolutionByUserComponent);
    ...
    it('should initialize dataArray correctly from filterService data', () => {
        ...
        component.ngOnInit();
        expect(component.dataArray).toEqual(mockData['fup/rbu/list'].body.content);
    });
