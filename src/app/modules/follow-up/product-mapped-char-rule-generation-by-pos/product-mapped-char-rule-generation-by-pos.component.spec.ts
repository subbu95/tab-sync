import { ProductMappedCharRuleGenerationByPosComponent } from './product-mapped-char-rule-generation-by-pos.component';
...
describe('ProductMappedCharRuleGenerationByPosComponent', () => {
    let fixture: ComponentFixture<ProductMappedCharRuleGenerationByPosComponent>;
    let component: ProductMappedCharRuleGenerationByPosComponent;
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [ProductMappedCharRuleGenerationByPosComponent, BrowserAnimationsModule],
            providers: [
                { provide: FilterapiService, useValue: filterapiServiceSpy }
            ],
        }).compileComponents();
        fixture = TestBed.createComponent(ProductMappedCharRuleGenerationByPosComponent);
    ...
    it('should initialize dataArray correctly from filterService data', () => {
        ...
        component.ngOnInit();
        expect(component.dataArray).toEqual(mockData['fup/prg/list'].body.content);
    });
