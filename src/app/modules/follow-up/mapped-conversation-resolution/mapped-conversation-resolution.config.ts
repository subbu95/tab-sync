...
export const listApi = 'fup/mcr/list';
export const excelExportApiPath = 'fup/mcr/excelExport'
export const columns = ['Country', 'Week id', 'User', 'CVN id', 'CVN code', 'Version', 'Last step', 'Session', 'Status', 'Result', 'Unix', 'Job id', 'Date'];
...
export const historyScreenDetails: historyScreenDetailsObject = {
    'screenTitle': 'MCR3 - Mapped conversion resolution',
    'screenComponentName': 'mapped-conversation-resolution',
...
export const screenHeaderComponentDetails: screenHeaderComponentDetailsObject = {
    screenTitle: 'MCR1 - Mapped conversion resolution- last steps',
    back: {
