import { MappedConversationResolutionComponent } from './mapped-conversation-resolution.component';
...
describe('MappedConversationResolutionComponent', () => {
    let fixture: ComponentFixture<MappedConversationResolutionComponent>;
    let component: MappedConversationResolutionComponent;
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [MappedConversationResolutionComponent, BrowserAnimationsModule],
            providers: [
                { provide: FilterapiService, useValue: filterapiServiceSpy }
            ],
        }).compileComponents();
        fixture = TestBed.createComponent(MappedConversationResolutionComponent);
    ...
    it('should initialize dataArray correctly from filterService data', () => {
        ...
        component.ngOnInit();
        expect(component.dataArray).toEqual(mockData['fup/mcr/list'].body.content);
    });
