import { ProductMappedCharResolutionComponent } from './product-mapped-char-resolution.component';
...
describe('ProductMappedCharResolutionComponent', () => {
    let fixture: ComponentFixture<ProductMappedCharResolutionComponent>;
    let component: ProductMappedCharResolutionComponent;
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [ProductMappedCharResolutionComponent, BrowserAnimationsModule],
            providers: [
                { provide: FilterapiService, useValue: filterapiServiceSpy }
            ],
        }).compileComponents();
        fixture = TestBed.createComponent(ProductMappedCharResolutionComponent);
    ...
    it('should initialize dataArray correctly from filterService data', () => {
        ...
        component.ngOnInit();
        expect(component.dataArray).toEqual(mockData['fup/pmr/list'].body.content);
    });
