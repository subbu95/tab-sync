...
export const listApi = 'fup/pmr/list';
...
export const historyScreenDetails: historyScreenDetailsObject = {
    'screenTitle': 'PMR3 - Product mapped char resolution',
    'screenComponentName': 'product-mapped-char-resolution',
...
export const screenHeaderComponentDetails: screenHeaderComponentDetailsObject = {
    screenTitle: 'PMR1 - Product mapped char resolution- last steps',
    back: {
