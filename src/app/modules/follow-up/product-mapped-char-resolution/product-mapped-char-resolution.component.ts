...
import * as pmrConfig from './product-mapped-char-resolution.config'
...
@Component({
  selector: 'eclipse-product-mapped-char-resolution',
  standalone: true,
  ...
  templateUrl: './product-mapped-char-resolution.component.html',
  styleUrl: './product-mapped-char-resolution.component.scss',
})
export class ProductMappedCharResolutionComponent implements OnInit, OnDestroy, AfterViewInit {
  title = CONSTANTS.DETAILS_TITLE;
  monId!: number;
  detailsPath: string = CONSTANTS.FUP.PMR.STEP_DETAILS_API_PATH;
  ...
  public columns = pmrConfig.columns; // Get the grid column names from component config
  public filterFieldDetails!: filterFieldDetailsObject; // Get the filter field details from component config
  public filterDetails = pmrConfig.filterDetails; // Get the filter details from component config
  public screenHeaderComponentDetails = pmrConfig.screenHeaderComponentDetails; // Get the header details from component config like title & action buttons
  public historyScreenDetails = pmrConfig.historyScreenDetails; // Get the history screen details from component config
  public excelExportApiPath = pmrConfig.excelExportApiPath;
  ...
  ngOnInit() {
    ...
    this.route.queryParams.subscribe((params) => {
      pmrConfig.filterFieldDetails.dropDown?.forEach(field => {
      ...
      this.filterFieldDetails = pmrConfig.filterFieldDetails;
